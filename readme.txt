...
1. Calendar view
2. Site visitors can add an event to calendar 
3. Site visitors can share an event via social media and email
4. Calendars come with auto timezone detection, timezone switcher, and 12/24 hour clock
5. Events list
