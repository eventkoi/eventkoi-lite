...
= 1.3.13.0 =
* New: Frontend Submissions tab previewing the Pro event-submission feature.
* Improved: Calendar search now scopes results by month with clearer previous/next controls.
* Improved: More calendar and event labels are now translatable.
* Improved: Event editor toolbar — single-row layout, H1–H4 toggle-off, clearer "Switch to HTML" labels, and video/YouTube button icons.
* Improved: More stable event ordering in the calendar shortcode.
* Fixed: Event query loop filters.
* Fixed: Dates not rendering on continuous (multi-day) standard events.
* Fixed: Multi-day events in the week view now show time ranges and a "Full day" label on spanning days.

= 1.3.12.2 =
* Fixed: Frontend event pages no longer fatally error on WordPress 7.0 due to a removed core function.

= 1.3.12.1 =
* Fixed: Calendar rendering and event date edge cases.

= 1.3.12.0 =
* Fixed: Various calendar and event management improvements.
* New: Divi page builder integration with calendar, event, and loop modules.

= 1.3.11.0 =
* Fixed: Recurring event handling and calendar display refinements.
* New: Beaver Builder and Elementor loop integrations.

== Upgrade Notice ==

= 1.3.13.0 =
Calendar search, translation, and multi-day display improvements plus event submission and query loop fixes.
